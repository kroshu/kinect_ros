...
def generate_launch_description():
    ...
    moveit_iiwa_yaml_file_name = get_package_share_directory('kinect_ros_trace_endpoint') + "/config/moveit_iiwa14.yaml"
    ...
    kinect_ros_trace_endpoint_node = Node(package='kinect_ros_trace_endpoint',
                               ...
                               parameters=[moveit_iiwa_yaml_file_name,
                                           ...
                                           fake_controller])
    # RViz
    rviz_config_file = get_package_share_directory('kinect_ros_trace_endpoint') + "/launch/kinect_ros_trace_endpoint.rviz"
    ...
    joint_state_publisher = Node(package='joint_state_publisher',
                                 ...
                                 arguments=[get_package_share_directory('urdflbriiwa14') + "/urdf/urdflbriiwa14.urdf"],
                                 output='log',
                                 parameters=[{'source_list': ["/fake_controller_joint_states"]}])

    return LaunchDescription([ static_tf, robot_state_publisher, rviz_node, joint_state_publisher, kinect_ros_trace_endpoint_node])
