# Copyright 2020 Zoltán Résijoint_controller
#
...
def generate_launch_description():
    ...
    kinect_ros_trace_endpoint_node = Node(package='kinect_ros_trace_endpoint',
                               ...
                               remappings=[('fake_controller_joint_states', 'reference_joint_state')],
    ...
    joint_controller = launch_ros.actions.LifecycleNode(
        ...
        name='joint_controller', remappings=[('measured_joint_state', 'lbr_joint_state'), ('joint_command', 'lbr_joint_command')]
        )
